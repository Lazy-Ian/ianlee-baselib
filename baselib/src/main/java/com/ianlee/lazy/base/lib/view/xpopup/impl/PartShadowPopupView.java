...
import com.ianlee.lazy.base.lib.view.xpopup.interfaces.OnClickOutsideListener;
import com.ianlee.lazy.base.lib.view.xpopup.util.XPopupUtils;
import com.ianlee.lazy.base.lib.view.xpopup.widget.PartShadowContainer;
...
public abstract class PartShadowPopupView extends BasePopupView {
    ...
    protected void addInnerContent() {
        ...
        if (getImplLayoutId() instanceof View) {
            ...
            contentView = LayoutInflater.from(getContext()).inflate((Integer) getImplLayoutId(), attachPopupContainer, false);
        }
