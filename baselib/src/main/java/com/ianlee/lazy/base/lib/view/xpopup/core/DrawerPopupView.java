...
import com.ianlee.lazy.base.lib.view.xpopup.widget.PopupDrawerLayout;
...
public abstract class DrawerPopupView extends BasePopupView {
    ...
    protected void addInnerContent(){
        ...
        if (getImplLayoutId() instanceof View) {
            ...
            contentView = LayoutInflater.from(getContext()).inflate((Integer) getImplLayoutId(), drawerContentContainer, false);
        }
