...
import com.ianlee.lazy.base.lib.view.xpopup.widget.SmartDragLayout;
...
public class BottomPopupView extends BasePopupView {
    ...
    protected void addInnerContent() {
        ...
        if (getImplLayoutId() instanceof View) {
            ...
            contentView = LayoutInflater.from(getContext()).inflate((Integer) getImplLayoutId(), bottomPopupContainer, false);
        }
