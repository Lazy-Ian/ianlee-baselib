...
import com.ianlee.lazy.base.lib.utils.SettingUtil
import com.ianlee.lazy.base.lib.view.recyclerview.SwipeRecyclerView


/**
 * Created by Lee on 2020/11/9
 * Email: yixin0212@qq.com
 * Function :这是这个类的主角，如何自定义LoadMoreView。
 */

class DefineLoadMoreView(context: Context) : LinearLayout(context), com.ianlee.lazy.base.lib.view.recyclerview.SwipeRecyclerView.LoadMoreView,
    View.OnClickListener {

    val mProgressBar: ProgressBar
    private val mTvMessage: TextView

    private var mLoadMoreListener: com.ianlee.lazy.base.lib.view.recyclerview.SwipeRecyclerView.LoadMoreListener? = null

    fun setmLoadMoreListener(mLoadMoreListener: com.ianlee.lazy.base.lib.view.recyclerview.SwipeRecyclerView.LoadMoreListener) {
     ...
     */
    override fun onWaitToLoadMore(loadMoreListener: com.ianlee.lazy.base.lib.view.recyclerview.SwipeRecyclerView.LoadMoreListener) {
