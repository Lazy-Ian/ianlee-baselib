package com.ianlee.lazy.base.lib.view.recyclerview;
...
import com.ianlee.lazy.base.lib.view.recyclerview.touch.DefaultItemTouchHelper;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnItemMoveListener;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnItemMovementListener;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnItemStateChangedListener;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnOpenMenuListener;
...
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnItemStateChangedListener;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnOpenMenuListener;
import com.ianlee.lazy.base.lib.view.recyclerview.widget.DefaultLoadMoreView;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.DefaultItemTouchHelper;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnItemMoveListener;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnItemMovementListener;
import com.ianlee.lazy.base.lib.view.recyclerview.touch.OnItemStateChangedListener;
...
/**
 * Created by lx on 2019/8/15.
 * <p>
 * E_mail:lixin062012@gmail.com
 * E_mail:yixin0212@qq.com
 * **[]**
 */
public class SwipeRecyclerView extends RecyclerView {
    ...
    public void setOnOpenMenuListener(OnOpenMenuListener listener) {
        initializeItemTouchHelper();
        this.mItemTouchHelper.setOnOpenMenuListener(listener);
    }
    ...
    public void setOnItemOpenMenuListener(OnOpenMenuListener listener) {
        if (listener == null) return;
        checkAdapterExist("Cannot set item click listener, setAdapter has already been called.");
        this.mOnOpenMenuListener = new ItemOpenMenuListener(this, listener);
    }
    private static class ItemOpenMenuListener implements OnOpenMenuListener {

        private SwipeRecyclerView mRecyclerView;
        private OnOpenMenuListener mListener;

        public ItemOpenMenuListener(SwipeRecyclerView recyclerView, OnOpenMenuListener listener) {
            this.mRecyclerView = recyclerView;
            this.mListener = listener;
        }
        ...
        @Override
        public void onOpenMenu(SwipeMenuBridge menuBridge, int position) {
            if (mListener!= null){
                mListener.onOpenMenu(menuBridge,position);
            }
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (adapter == null) {
            ...
            mAdapterWrapper.setOnOpenMenuListener(mOnOpenMenuListener);
    ...
    public void setIsAddmenu(boolean isAddMenu) {
