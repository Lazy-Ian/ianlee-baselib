...
import com.ianlee.lazy.base.lib.view.xpopup.enums.DragOrientation;
import com.ianlee.lazy.base.lib.view.xpopup.util.XPopupUtils;
import com.ianlee.lazy.base.lib.view.xpopup.widget.PositionPopupContainer;
...
public class PositionPopupView extends BasePopupView {
    ...
    public PositionPopupView(@NonNull Context context) {
        ...
        if (getImplLayoutId() instanceof View) {
            ...
            contentView = LayoutInflater.from(getContext()).inflate((Integer) getImplLayoutId(), positionPopupContainer, false);
        }
