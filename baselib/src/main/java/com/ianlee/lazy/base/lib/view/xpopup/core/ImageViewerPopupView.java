...
import com.ianlee.lazy.base.lib.view.xpopup.enums.PopupStatus;
import com.ianlee.lazy.base.lib.view.xpopup.interfaces.OnDragChangeListener;
...
import com.ianlee.lazy.base.lib.view.xpopup.photoview.PhotoView;
import com.ianlee.lazy.base.lib.view.xpopup.util.PermissionConstants;
import com.ianlee.lazy.base.lib.view.xpopup.util.XPermission;
import com.ianlee.lazy.base.lib.view.xpopup.util.XPopupUtils;
import com.ianlee.lazy.base.lib.view.xpopup.widget.BlankView;
import com.ianlee.lazy.base.lib.view.xpopup.widget.HackyViewPager;
import com.ianlee.lazy.base.lib.view.xpopup.widget.PhotoViewContainer;
...
public class ImageViewerPopupView extends BasePopupView implements OnDragChangeListener, View.OnClickListener {
    ...
    public ImageViewerPopupView(@NonNull Context context) {
        ...
        if (getImplLayoutId() != null) {
            if (getImplLayoutId() instanceof View) {
                customView = (View) getImplLayoutId();
            } else if ((getImplLayoutId() instanceof Integer)) {
                customView = LayoutInflater.from(getContext()).inflate((Integer) getImplLayoutId(), container, false);
            }
