...
import com.ianlee.lazy.base.lib.view.xpopup.widget.BubbleLayout;
...
public abstract class BubbleAttachPopupView extends BasePopupView {
    ...
    protected void addInnerContent() {
        ...
        if (getImplLayoutId() instanceof View) {
            ...
            contentView = LayoutInflater.from(getContext()).inflate((Integer) getImplLayoutId(), bubbleContainer, false);
        }
