...
import static com.ianlee.lazy.base.lib.view.recyclerview.SwipeRecyclerView.LEFT_DIRECTION;
import static com.ianlee.lazy.base.lib.view.recyclerview.SwipeRecyclerView.RIGHT_DIRECTION;
...
/**
 * Created by YanZhenjie on 2017/7/20.  BaseSrvAdapter  RecyclerView.Adapter<RecyclerView.ViewHolder>
 */
public class AdapterWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    void setOnOpenMenuListener(OnOpenMenuListener listener) {
        this.mOnOpenMenuListener = listener;
    }
    ...
    public final void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position,
        ...
        if (itemView instanceof SwipeMenuLayout && mSwipeMenuCreator != null) {
            ...
            if (leftMenu.hasMenuItems()) {
                ...
                menuLayout.setOnOpenMenuListener((menuBridge, position12) -> {
                    if (mOnOpenMenuListener != null) {
                        mOnOpenMenuListener.onOpenMenu(leftMenuView.getTag(),finalPosition);
                    }
                });
            ...
            if (rightMenu.hasMenuItems()) {
                ...
                menuLayout.setOnOpenMenuListener((menuBridge, position12)  -> {
                    if (mOnOpenMenuListener != null) {
                        mOnOpenMenuListener.onOpenMenu(rightMenuView.getTag(),finalPosition);
                    }
                });
